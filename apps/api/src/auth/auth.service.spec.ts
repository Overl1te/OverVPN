...
const environment: AppEnvironment = {
  ...
  AMNEZIAWG_LAST_KNOWN_GOOD_PATH: '/tmp/amneziawg/config.lkg.json',
  AMNEZIAWG_RELOAD_REQUEST_PATH: '/tmp/amneziawg/reload/request',
  AMNEZIAWG_RELOAD_ACK_PATH: '/tmp/amneziawg/reload/ack',
  AMNEZIAWG_PID_PATH: '/tmp/amneziawg/reload/amneziawg.pid',
  AMNEZIAWG_HEARTBEAT_PATH: '/tmp/amneziawg/reload/heartbeat',
  AMNEZIAWG_HEARTBEAT_MAX_AGE_SECONDS: 15,
  AMNEZIAWG_RUNTIME_STATS_PATH: '/tmp/amneziawg/reload/runtime-stats.json',
  AMNEZIAWG_RUNTIME_STATS_MAX_AGE_SECONDS: 30,
  AMNEZIAWG_PORT: 51_822,
  AMNEZIAWG_PROCESS_TIMEOUT_MS: 15_000,
  AMNEZIAWG_RELOAD_TIMEOUT_MS: 20_000,
  AMNEZIAWG_HEALTH_TIMEOUT_MS: 5_000,
  SING_BOX_UDP_PORT: 443,
  SING_BOX_TCP_PORT: 4443,
  SING_BOX_TROJAN_PORT: 8444,
  SING_BOX_SS_PORT: 8445,
  SING_BOX_WG_PORT: 51_820,
